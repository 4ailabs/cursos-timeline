# Guion — Sesión 2: "La Línea Paterna y el Camino que Caminas"

### Recuperación de la Sesión 1 + Los Cuatro Caminos + Demostración en vivo
...
Sin tiempos fijos — dividido en bloques secuenciales. El facilitador avanza de uno al siguiente cuando el grupo está listo.

**Nota de diseño (uso interno):** esta sesión tiene dos naturalezas distintas. La Hora 1 es marco conceptual (misma lógica de la Sesión 1). La Hora 2 es una **demostración observada** — el grupo no ejecuta la técnica, mira al Dr. Ojeda trabajar un caso real. Por eso la Hora 2 se diseña con los marcos del **aprendizaje por observación** (Bandura: atención → retención → reproducción diferida → motivación) y del **aprendizaje cognitivo por modelado** (Collins/Brown/Newman: el experto hace visible su razonamiento pensando en voz alta). El grupo no aprende a *hacer* la técnica hoy — aprende a *leer* lo que un terapeuta formado hace con ella. Ver `README.md` §5, "Regla de las demos".

***

# HORA 1 — Marco conceptual: la línea paterna y los Cuatro Caminos

## Bloque 1 — Recuperación de la Sesión 1

**\[Slide 1 — título de sesión + recordatorio de las 4 sesiones, con la Sesión 1 marcada como completada]**
...
> Tengan a la mano el genograma que construyeron en la Sesión 1. Sin abrir el chat todavía, respondan mentalmente tres cosas: primero, ¿qué código de patrón marcaron con asterisco —A de edad o fecha, R de rol, o E de tipo de evento por rama—? Segundo, ¿en qué línea apareció, la materna o la paterna? Tercero, ¿lo pudieron explicar en una sola frase? (pausa breve)
>
> Quien no traiga el genograma terminado: no importa para hoy. La demostración de esta sesión se puede seguir sin él. Pero anótenlo como pendiente — en la Sesión 4 volvemos a ese mismo árbol.

**Nota de facilitación:** esta recuperación es el "momento 0" del molde de clase mundial (práctica espaciada). No la salten aunque haya prisa — es lo que convierte cuatro sesiones sueltas en una formación. El co-facilitador de Zoom confirma en voz alta que está activo, igual que en la Sesión 1.
...
## Bloque 3 — Por qué la línea paterna se trabaja aparte: el cromosoma Y

**\[Slide 2 — diagrama del cromosoma Y pasando intacto padre → hijo varón → nieto varón, en paralelo a la línea materna del mtDNA vista en la Sesión 1]**

> En la Sesión 1 vimos que hay dos líneas genéticas, y solo dos, que se transmiten completas de una generación a la siguiente sin mezclarse con el aporte del otro progenitor. La línea materna —el ADN mitocondrial— la trabajamos la próxima semana. Hoy es el turno de la otra: el cromosoma Y.
>
...
## Bloque 4 — El mapa: los Cuatro Caminos de la Vida

**\[Slide 3 — la rosa de los cuatro caminos: Norte/Migrante, Sur/Sufrimiento, Oeste/Deber, Este/Placer, con su emoción central y polaridad]**

> El instrumento con el que hoy se lee la línea paterna es un modelo del Instituto: los Cuatro Caminos de la Vida. Es un mapa de cuatro direcciones, trazado sobre los ejes cardinales, donde cada dirección representa una tendencia predominante en cómo una persona se relaciona con la vida, decide y repite patrones.
>
...
**Nota de facilitación:** este es el concepto nuclear de la sesión, presentado en un solo trozo (chunking). No abrir a preguntas todavía — los tres marcos que lo sostienen vienen en el bloque siguiente y contestan la mayoría de las dudas antes de que se formulen.

***

## Bloque 5 — Qué sostiene cada camino: los tres marcos
...
**Nota de encuadre (uso interno, no se lee al grupo):** los tres marcos tienen estatus distinto. El cromosoma Y (Bloque 3) es biología establecida. Los metaprogramas (PNL) y los movimientos sistémicos (constelaciones) son marcos clínicos, no ciencia dura — la audiencia ya los usa y los reconoce como tales. Las correspondencias neurobiológicas por camino (dopamina, cortisol, vago ventral) son el modelo del Instituto que mapea el estado del sistema nervioso a cada dirección; se presentan como el mapa que usa la herramienta, no como hallazgos de laboratorio por camino. No sobreafirmar el detalle neuroquímico — se afirma la dirección clínica, no una medición.

***

## Bloque 6 — Cuando caen dos caminos a la vez: los cuadrantes
...
## Bloque 7 — Las 7 primeras improntas: el patrón que marca una línea
...
**Nota de encuadre (uso interno, no se lee al grupo):** terminología vigente de **BV4** —improntas i1–i13, no "hologramas"— para un solo idioma con la Sesión 1; las 13 improntas son la reformulación actual del catálogo antiguo de 13 hologramas de Bioenergética Holográfica (i1 = ex-Holograma 1 … i7 = ex-Holograma 7). La lectura transgeneracional de **i7 Hibernación** es explícita en el tratado (BV4 Cap. 15 §15.6: rendición extrema ante guerra/hambre/opresión). Las lecturas transgeneracionales de **i1–i6** son aplicación editorial de la lógica de BV4 (Cap. 15: *se hereda el umbral, no el evento*) a cada impronta del Cap. 7 — consistentes con el modelo, no citadas literalmente; el tratado nombra i7/i9/i10/i11 como las de mayor incidencia transgeneracional, así que de estas siete la más típica por la línea es i7. La impronta se usa aquí solo como **rejilla de lectura**, no como técnica de tratamiento (el embudo temporal y el acto de quiebre con su devolución son clínicos, 1:1, no de beca). Fuentes: Tratado BV4 Cap. 7 (nombres y creencias) y Cap. 15 (lógica transgeneracional).

***

## Bloque 8 — Momento somático: hacia dónde cae tu propia línea

*Diseñado con la skill ritual-creator (Tratado BV4), calibrado en Nivel Bajo de intensidad. Es un **ritual de orientación, no de quiebre**: sigue la columna TAME completa pero se detiene por debajo del acto de quiebre —sin mismatch, sin acto irreversible, sin trabajo de descarga clínica—, porque es un ejercicio grupal de \~50 personas, no una intervención 1:1. Su objeto transformado es el propio genograma, que el participante marca al cierre y se lleva. Prepara la atención para la demo: el grupo entra a observar el caso del voluntario habiendo sentido primero la pregunta en su propio cuerpo.*
...
> *"Los hombres de mi línea paterna, ¿hacia dónde caminaron? ¿Se fueron —Norte—? ¿Cargaron dolor —Sur—? ¿Sirvieron, cumplieron un deber —Oeste—? ¿O buscaron disfrutar —Este—?"* (pausa breve, sin resolver)
> *"¿Y yo? ¿Camino hacia el mismo lado que ellos, o hacia el opuesto?"* (pausa breve)

**Paso 5 — Dónde aparece.** Al sostener esa pregunta, algo se hizo presente en el cuerpo. Localicen dónde — sin corregirlo, sin cambiarlo.

> *"Al pensar en la línea, ¿en qué parte del cuerpo se hizo presente algo? El pecho, la garganta, el vientre, la espalda, los hombros. Lleven la atención ahí y déjenla."* (pausa)

**Paso 6 — La cualidad de lo que aparece.** El facilitador lee despacio, con pausas largas entre cada pregunta — no se responde en voz alta, solo se deja que el cuerpo conteste.

> *"Eso que notan ahí… ¿tiene una forma? ¿Es un punto, o se extiende?"* (pausa)
> *"¿Pesa, o es liviano?"* (pausa)
> *"¿Es frío, o es cálido?"* (pausa)
> *"¿Está quieto, o tiene algún movimiento?"* (pausa)
> *"Y si tuviera un color, ¿cuál sería?"* (pausa larga)
> *"No hay respuesta correcta. Solo dejen que el cuerpo conteste, a su ritmo."*

**Paso 7 — El instante en que algo encaja.** En algún momento, al nombrar una de esas cualidades, puede que algo en el cuerpo responda — la respiración se hace más honda, algo se afloja o se acomoda. Esa es la señal de que nombraron lo que era.

> El facilitador guía: *"Si algo se movió al ponerle nombre, no hagan nada con eso — solo regístrenlo. Y si nada se movió, también está bien: el cuerpo habla cuando está listo."* (pausa)
> Y para ustedes, en voz baja, una frase de reconocimiento: *"Esto es lo que traigo. Lo reconozco."* (pausa)

**Paso 8 — El gesto y la pausa.** Una mano se extiende hacia adelante, en la dirección que la persona sienta —sin pensarlo demasiado—; la otra queda sobre el pecho.

> Decir en voz baja, con la mano extendida: *"Esta es la dirección que siento, y esto es lo que mi cuerpo trae de la línea."* (mantener la mano extendida)

Y entonces la pausa — el momento que más se salta y el que hace que el trabajo llegue al cuerpo. No pasar de inmediato a lo siguiente.

> El facilitador guía, y después calla: *"Quédense así unos segundos. No hagan nada. Dejen que el cuerpo termine lo que empezó."* (silencio real, 20-30 segundos — respetar el silencio aunque se sienta largo; si aparece un suspiro, un temblor fino, calor, es el cuerpo cerrando el ciclo)

**Paso 9 — Lo nuevo: diferenciar.** Las dos manos giran, palmas hacia arriba, sobre las piernas — el gesto de recibir, opuesto al de cargar con el que empezaron. Aquí no se suelta nada todavía —eso es trabajo de otro día, y de otro encuadre—; solo se abre la posibilidad de que no todo lo que se trae sea propio.

> *"Esto lo traigo. No todo lo que traigo es mío. Hoy solo lo miro."* (pausa breve)

**Cierre — el ancla.** Abran los ojos. Con un lápiz, en el margen de su genograma, marquen dos cosas: la dirección que sintieron —una flecha— y una palabra de la cualidad que apareció —el color, el peso, lo que haya sido—. Ese árbol marcado es lo que se llevan hoy; en la demostración van a verlo cobrar sentido.

> *"Con esto entro a mirar."*
...
## Cierre de Hora 1 — Transición a la demostración
...
# HORA 2 — La demostración: el Dr. Ojeda trabaja un caso real

*El grupo observa, no ejecuta. La sección está diseñada con los marcos del aprendizaje por observación (Bandura) y el modelado cognitivo (think-aloud). El objetivo de aprendizaje de esta hora no es "sé hacer la técnica" — es "sé leer lo que un terapeuta formado hace con la técnica, y reconozco hasta dónde llega".*

## Sección 1 — Encuadre de la observación (qué mirar)

**\[Slide 8 — guía de observación: 3 focos — 1) la dirección de la caída · 2) las preguntas que hace el Dr. y por qué · 3) cómo conecta el resultado con el genosociograma]**

> Antes de traer al voluntario, les doy el mapa de lo que van a ver, para que su atención no se disperse. En una demostración, lo que uno no sabe mirar, se pierde — así que fijen la mirada en tres cosas.
>
...
**Instrucción de registro para el grupo:**

> Tengan papel a un lado. No van a anotar la historia del voluntario —eso es de él—. Van a anotar una sola cosa: **cada vez que yo haga una pregunta, escriban qué creen que me llevó a hacerla.** Al final comparamos. Ese es su ejercicio de hoy.

**Nota de facilitación:** este encuadre es lo que convierte una demo pasiva en aprendizaje. En términos del marco de Bandura, la fase de *atención* es el cuello de botella de todo aprendizaje por observación — sin foco dirigido, el observador retiene anécdota, no método. Los tres focos + la tarea de registro son el andamiaje de atención. El Slide 8 permanece visible toda la demo.

***

## Sección 2 — Preparación del material a la vista del grupo

**\[Slide 9 — foto o esquema del setup: hoja doble carta con ejes N-S-E-O trazados, tabla giratoria, muñecos Playmobil etiquetados]**

> El material es sencillo, y lo preparo frente a ustedes para que lo vean completo. Una hoja doble carta con los cuatro ejes cardinales trazados: Norte arriba —Migrante—, Sur abajo —Sufrimiento—, Este a la derecha —Placer—, Oeste a la izquierda —Deber—, y los cuadrantes marcados en las diagonales. La hoja va sobre una tabla giratoria, que me permite mirar la caída desde distintos ángulos sin mover el muñeco. Y los muñecos Playmobil, uno por cada miembro de la familia que vamos a trabajar — cada uno etiquetado con su nombre.
>
> Para hoy, con el voluntario, trabajamos la línea paterna: un muñeco para él, uno para su padre, uno para su abuelo paterno. Con eso alcanza para mostrar la lectura.

**Nota de facilitación (crítica):** este material es de trabajo del Dr. Ojeda — **no se reparte a los participantes** (README §5, tabla de materiales). El grupo lo ve; no lo toca. Filmar el setup y la caída de cerca (memoria \[\[feedback\_no\_simplificar\_maniobras]]: la maniobra se captura completa, sin simplificar, para el curso grabado).

***

## Sección 3 — Selección del voluntario y de los muñecos

> Necesito un voluntario que tenga presente su línea paterna — al menos padre y abuelo paterno, con lo que sepa de sus vidas: de dónde eran, a qué se dedicaron, qué les tocó vivir. No hace falta que sea una historia dramática. Cualquier línea sirve para mostrar la lectura.

*(El Dr. selecciona un voluntario — de sala preferentemente, por la manipulación física del material.)*

> Bien. Antes de tocar los muñecos, una instrucción para ti \[voluntario]: elige los muñecos que sientas que representan a cada uno — a ti, a tu padre, a tu abuelo. No lo pienses mucho, déjate llevar por la intuición. La elección ya es información.

**Think-aloud del Dr. (dirigido al grupo, no al voluntario):**

> Fíjense en algo que acaba de pasar: no le pedí que eligiera "bien". Le pedí que eligiera intuitivamente. Cuál muñeco elige para el padre —el más grande, el que está de espaldas, el que tiene una herramienta en la mano— ya me dice algo antes de soltar nada. Eso es lo primero que registro.

**Nota de facilitación:** aquí empieza el modelado cognitivo. La regla de oro de esta hora: **cada acción del Dr. va acompañada de por qué la hace, dicho al grupo.** El voluntario vive el proceso; el grupo escucha el razonamiento. Son dos canales simultáneos.

***

## Sección 4 — La caída (paso técnico central)

**\[Slide 10 — esquema de la técnica de caída: muñeco de pie en el centro → se suelta → cae → dirección de los pies = camino]**

> Coloca los tres muñecos de pie en el centro de la hoja, sobre la cruz de los ejes. (pausa) Ahora tomamos el tuyo primero. Lo levanto unos centímetros sobre el centro, verticalmente — no lo lanzo, no lo empujo — y lo suelto. Observemos hacia dónde cae.

*(Se suelta el muñeco del voluntario. Se observa la dirección de los pies.)*
...
## Sección 5 — La lectura (el corazón de la demostración)

**\[Slide 11 — las preguntas por camino, del Documento Base §13: Norte→"¿hay migraciones en tu familia?" · Sur→"¿historias de sufrimiento nunca habladas?" · Oeste→"¿quién se sacrificó más?" · Este→"¿se permitía disfrutar?"]**

> Aquí es donde trabaja el terapeuta. La caída me dio una dirección; ahora hago las preguntas que corresponden a ese camino, y escucho si la vida del voluntario y de su línea las confirma o las desmiente.

*(El Dr. conduce el diálogo con el voluntario según la dirección que cayó. Ejemplos de las preguntas ancla, del Documento Base — el Dr. usa las que correspondan al caso real:)*

> — Si cayó al **Norte**: *"¿Hay migraciones en tu familia? ¿Alguien tuvo que irse de su tierra? ¿Sientes tú también esa necesidad de moverte, de no quedarte en un lugar?"*
> — Si cayó al **Sur**: *"¿Hay historias de sufrimiento en tu familia que nunca se hablaron? ¿Sientes que cargas un peso que no empezó contigo?"*
> — Si cayó al **Oeste**: *"¿Quién en tu familia fue el que más se sacrificó? ¿Te identificas con esa persona? ¿Sientes que tu vida está al servicio de otros?"*
> — Si cayó al **Este**: *"¿En tu familia se permitía disfrutar, o el placer se veía mal? ¿Sientes culpa cuando las cosas te van bien?"*
...
## Sección 6 — Cierre del caso y devolución al voluntario
...
**Nota de facilitación:** contención. El voluntario abrió su línea paterna frente a 50 personas — el Dr. cierra su caso con cuidado antes de pasar al debrief grupal. Si algo quedó activado, el co-facilitador lo acompaña 1:1 en el receso. No se deja al voluntario "abierto" para pasar al análisis.

***

## Sección 7 — Debrief: qué vieron (retención → aplicación)

> Ahora ustedes. Miren sus notas — les pedí que anotaran, cada vez que hice una pregunta, qué creían que me llevó a hacerla. Quiero dos o tres voluntarios que compartan una: ¿qué pregunta me vieron hacer, y qué creen que la disparó?
...
## Sección 8 — Cierre de sesión y puente

**\[Slide 13 — las dos herramientas del programa: Sesión 2 (paterna · Los Caminos de la Vida) hecha; Sesión 3 (materna · Campos Mórficos) siguiente]**

> Hoy vieron la línea paterna leída como una dirección, con una herramienta que la hace visible en minutos. La próxima semana hacemos lo complementario: la línea materna, con una vía de acceso completamente distinta —el campo familiar, los Campos Mórficos—. Traigan el mismo genograma. Y la Sesión 4 vuelve a este árbol para llevarlo dos generaciones más atrás, hasta lo que se hereda en el cuerpo, en el metabolismo.
>
> La sesión quedó grabada, disponible para quien quiera revisar la demostración con calma.

**Cierre — gancho hacia los cursos (se dice al final, después de la demo, no antes):**
...
**Nota de facilitación:** el gancho va **al final y una sola vez** (README §5), después de que la demo y el momento somático ya generaron el interés por sí solos. La clave estratégica de esta beca: **el alumno se inscribe a lo que vivió o vio, no a lo que se le anuncia en abstracto** — antes se anunciaban los cursos y, sin haberlos probado, no se inscribían; aquí cada curso se engancha a una experiencia concreta que el grupo acaba de tener. Por eso el módulo conecta con **dos** cursos por dos vías distintas: la **demostración** (Hora 2) engancha a *Playmobil Pro / Los Caminos de la Vida* — la puerta de *leer*; el **momento somático** (Bloque 8) engancha a *Actos que Mueven* — la puerta de *mover*. No adelantar ninguno a la Hora 1 ni repetirlos. Tono de invitación, no de venta.

***

## Fuentes de esta sesión

**Contenido de los Cuatro Caminos y la técnica:**

* Marco de los Cuatro Caminos (Migrante/Norte, Sufrimiento/Sur, Deber/Oeste, Placer/Este), emociones, polaridades, beneficios y costos por camino: `02_Base_Conocimiento/TerapiaMunecosCaminos/Documento_Base_TerapiaMunecosCaminos.md` §1–5

* Los tres marcos que sostienen cada camino (metaprogramas PNL, mecanismos de supervivencia biológica, movimientos sistémicos familiares): mismo documento §8 (metaprogramas), §9 (mecanismos de supervivencia), §10 (movimientos sistémicos)

* Los cuadrantes (NE, NO, SE, SO) y sus dinámicas: mismo documento §6–7

* La técnica de los 7 pasos, la caída del muñeco, la determinación del camino por la dirección de los pies: mismo documento §12

* Las preguntas ancla por dirección de caída: mismo documento §13 (Posibles Resultados por Camino) y §16 (Preguntas Terapéuticas)

* La observación de dinámicas familiares (caminos iguales/opuestos/perpendiculares, posiciones de poder) y la pregunta de cierre: mismo documento §14 y §15 (Paso 12)

* Materiales (hoja doble carta con ejes, tabla giratoria, muñecos Playmobil Pro etiquetados): mismo documento §11

* Programa base y estructura de la sesión: `Programa_4_Sesiones_Beca.md` §4 (Sesión 2) y §5 (Regla de las demos)

* Cursos ancla del gancho (dos puertas): **Terapia con Muñecos: Playmobil Pro / Los Caminos de la Vida** (`02_Base_Conocimiento/TerapiaMunecosCaminos/`) para la puerta de *leer*; **Actos que Mueven — taller vivencial de Ritual Experiencing** (`03_Programas/Cursos_Selectos/Taller_Actos_que_Mueven/`, ver `05_Planificacion/Programa_Actos_que_Mueven_*.md`) para la puerta de *mover* — actos físicos irreversibles con secuencia TAME; el momento somático del Bloque 8 es su versión suave de grupo

**Las 7 primeras improntas (Bloque 7):**

* Las improntas i1–i7 (nombre y creencia que instala) como rejilla de lectura del patrón que marca una línea: **Tratado BV4, Cap. 7 "Las 13 Improntas"** (`~/tratado-bioenergetica-bv4/Parte_II_Taxonomia/Cap07_Las_13_Improntas.md`); i7 Hibernación como impronta de alta incidencia transgeneracional: **Cap. 15 §15.6**. Se usa el marco vigente de improntas (BV4), no el antiguo de "hologramas" — las 13 improntas son la reformulación actual del catálogo de 13 hologramas de Bioenergética Holográfica (mapeo 1:1: i1 = ex-H1 … i7 = ex-H7). En esta sesión se usan solo como marco de lectura, no como técnica de tratamiento; solo i1–i7, no i8–i13.

**Fundamento biológico de la línea paterna:**

* Cromosoma Y como línea paterna directa no recombinante (región NRY), contraparte del ADN mitocondrial materno: mismas fuentes de la Sesión 1 — [Human paternal and maternal demographic histories — PMC](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4174254/); base de la genealogía genética (haplogrupo paterno)

**Marcos de didáctica de clase mundial aplicados a esta sesión:**

* Molde de lección de clase mundial (recuperación de entrada, objetivo explícito, chunking, ejemplo trabajado, checkpoint, cierre metacognitivo) y escalera de Bloom: `Cursos_Selectos/El_Cuerpo_Electrico_RB/Curso_Vigente/Curso_Video_Modulo1/Guia_Pedagogica_Estandar_Mundial.md` §5; práctica de recuperación (Roediger), carga cognitiva y ejemplos trabajados (Sweller), backward design (Harvard Bok / Wiggins & McTighe)

* Aprendizaje por observación aplicado a la Hora 2 (fases atención → retención → reproducción diferida → motivación): teoría del aprendizaje social de Albert Bandura — [Bandura's Social Learning Theory — Simply Psychology](https://www.simplypsychology.org/bandura.html)

* Modelado cognitivo con "pensamiento en voz alta" (el experto articula su razonamiento mientras trabaja), articulación y reflexión: aprendizaje cognitivo (cognitive apprenticeship) de Collins, Brown & Newman — ["Cognitive Apprenticeship" Revisited — American Educator, 2020](https://files.eric.ed.gov/fulltext/EJ1272730.pdf); [Components of Cognitive Apprenticeship: Modeling — UBC Wiki](https://wiki.ubc.ca/MET:Components_of_Cognitive_Apprenticeship:_Modeling)

**Momento somático:**

* Diseñado con la skill `ritual-creator` (Nivel Bajo de intensidad para formato grupal); ver nota clínica interna en el Bloque 8. Abre el **canal somático-fenomenológico** de acceso al N3 en vez del test muscular: interocepción sin narrativa (Craig, 2002, 2009), localización corporal (Canal 2), rastreo de las cinco cualidades del *felt sense* y el *felt shift* (Canal 3, Gendlin). Fuentes: Tratado BV4, **Cap. 11 "Acceso al Inconsciente Biológico"** (`~/tratado-bioenergetica-bv4/Parte_III_Metodologia/Cap11_Acceso_al_Inconsciente_Biologico.md`, §11.3–11.4) y Cap. 2–3 (N3). Calibración de grupo: solo Canales 2 y 3; el Canal 4 completo (escucha somática profunda con descarga) es clínico 1:1, fuera de la beca.

**Continuidad con la Sesión 1:**

* Definición de lo transgeneracional, lealtades invisibles, la impronta como programa de supervivencia, los 4 niveles (N1–N4): `Guion_Sesion1_Mapa_Que_Cargas.md` (misma carpeta) y sus fuentes

***

## Notas de producción (para el curso grabado — paso 7 de la máquina)

* **Filmar de cerca:** el setup del material, la caída de cada muñeco, y la posición final del conjunto. Es la maniobra central y no debe simplificarse en la edición (memoria \[\[feedback\_no\_simplificar\_maniobras]]).

* **Capturar el think-aloud completo:** el audio del razonamiento del Dr. durante la lectura es el activo más valioso de la sesión para el curso grabado — es lo que no se puede reconstruir después.

* **Las preguntas del voluntario y del grupo en el debrief:** revelan dónde el concepto cuesta; ahí van los futuros "pausa y hazlo" de la versión grabada.

* **Anonimizar el caso del voluntario** antes de cualquier uso en remarketing (README §5: las sesiones se graban; el material biográfico individual requiere consentimiento explícito).
