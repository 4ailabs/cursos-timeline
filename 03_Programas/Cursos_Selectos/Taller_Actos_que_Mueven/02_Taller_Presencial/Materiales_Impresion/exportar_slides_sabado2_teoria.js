...
const URL_FILE = 'Sabado_2/Slides_Teoria_Sabado_2.html';
const OUT_DIR  = path.join(__dirname, '..', 'Programa_Final', 'export_imagenes', '09_Slides_Sabado2_Teoria');

(async () => {
  console.log('────────────────────────────────────────────────────────────');
  console.log('Actos que Mueven™ — Exportación Slides Sábado 2 Teoría');
  console.log('────────────────────────────────────────────────────────────\n');
