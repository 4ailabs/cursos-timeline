...
-- ============================================================
-- exportar_a_keynote.applescript
-- Crea una presentación Keynote con cada slide-XX.png del deck
-- de Bases de RB y el Punto Trauma, como diapositiva a página completa.
-- Estrategia: slide en blanco + imagen encima (sin tocar placeholders).
-- Cuenta los PNG presentes automáticamente (no hardcodea el total).
-- ============================================================

set slidesFolderPOSIX to "/Users/miguelojedarios/cursos-timeline/03_Programas/Cursos_Selectos/El_Cuerpo_Electrico_RB/Referencia/Punto_Trauma/Slides_Wellkitt/export_slides/"
set outputPath to "/Users/miguelojedarios/cursos-timeline/03_Programas/Cursos_Selectos/El_Cuerpo_Electrico_RB/Referencia/Punto_Trauma/Slides_Wellkitt/Bases_RB_y_Punto_Trauma.key"

-- Detectar cuántos slide-NN.png existen (hasta 99)
set fileList to {}
