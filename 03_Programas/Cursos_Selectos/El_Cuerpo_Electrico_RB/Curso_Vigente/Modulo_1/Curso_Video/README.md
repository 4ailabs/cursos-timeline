...
- **Los límites** siempre presentes: Levin no usó imanes estáticos (extrapolación); BEV no validada por ensayos; la config. de 2 imanes no verificada; el riñón regula el **K⁺**, no "el pH".
