...
y se actualiza republicando el HTML desde esta carpeta.

**Este es el sistema de composición adoptado para la Parte I**, en reemplazo de `build_manual_rb.py`
(que sigue vigente para las Partes II y III hasta que se les aplique el mismo tratamiento).
