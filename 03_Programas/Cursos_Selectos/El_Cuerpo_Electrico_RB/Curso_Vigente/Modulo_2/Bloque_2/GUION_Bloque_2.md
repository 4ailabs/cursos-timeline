# Bloque 2 · Guion de clase
## El programa de defensa y su tono

**Módulo 2 · Leer y regular** — Dr. Miguel Ojeda Rios · Instituto Centrobioenergetica

> Guion hablado. Lo que va entre corchetes es indicación, no se dice.
> Registro clínico. Audiencia: médicos, psicólogos, kinesiólogos y terapeutas corporales.
...
Tres frases ordenan el bloque, y las voy a dejar enunciadas desde el principio para que las vean venir.
...
El tono de defensa se puede subir con palabras.
...
Tiene todo lo que define a un agente en el marco que usamos.

Su meta: detectar la amenaza, contenerla, retirar lo dañado y reparar.
...
## Por qué es un programa antiguo

La maquinaria del inflamasoma está desde las esponjas. Los receptores tipo NLR aparecen en los animales más primitivos, y la caspasa-1 se encuentra en filos muy distantes —poríferos, cnidarios, moluscos, anélidos, artrópodos, nematodos— con sitios de activación conservados y estructuras del dominio CARD semejantes desde la esponja hasta el humano.

El aparato de la defensa está en animales sin sistema nervioso, sin sangre y sin órganos. Es anterior a casi todo lo demás.

Un matiz, que digo porque alguno de ustedes puede preguntarlo: el uso del inflamasoma como plataforma para procesar citoquinas proinflamatorias parece haber surgido más tarde, después de la divergencia entre peces y tetrápodos. La maquinaria es antiquísima; la función concreta que hoy le atribuimos es más reciente.

Y por qué esto importa clínicamente. Un programa tan conservado está altamente regulado precisamente porque es peligroso. Por eso tiene un freno propio, y ese freno es lo que viene ahora.

## Los tres tiempos del programa

`[Al pizarrón. Dibujarlo como secuencia, con tres cajas — no como una curva que sube y baja.]`

**Tiempo uno, el inicio.** Reconocimiento del daño o de la amenaza. Inflamasoma y liberación de mediadores.

**Tiempo dos, la ejecución.** La cascada química y celular: citoquinas, interleucinas, reclutamiento, fenotipos celulares.

**Tiempo tres, la resolución.** Y aquí está el punto que reencuadra el bloque completo: la resolución es un programa activo propio, con sus propios mediadores especializados — lipoxinas, resolvinas, protectinas.

Durante décadas se asumió que la inflamación termina porque los estímulos se agotan. Hoy sabemos que la resolución es un proceso activo y programado, con su propia bioquímica.

La inflamación no se apaga: se le apaga. Hay una orden de terminar, y esa orden se emite.

`[Pregunta al grupo. Esperar la respuesta.]`

Si la resolución es un programa aparte, ¿qué significa que un paciente lleve años inflamado?
...
La respuesta es que no. Y el experimento que lo demuestra usa un animal que ustedes ya conocen.

## El experimento de la salamandra

En la salamandra adulta se eliminaron los macrófagos antes de amputar el miembro. Si la intuición fuera correcta, sin defensa habría regeneración limpia.

Resultado: bloqueo completo de la regeneración, en todos los casos. Los muñones formaron tejido fibrótico con cicatriz permanente, todavía presente a los noventa días.

Y el detalle que más enseña: aunque los macrófagos repoblaron el tejido a las dos semanas, el miembro ya no volvió a formar blastema.

Dos conclusiones, y las dos operan.

La primera: quitar la defensa impide la regeneración.

La segunda: hay una ventana. El programa tiene que estar presente en su momento. Si no lo estuvo, después ya no sirve.
...
Pero el dato que decide la interpretación es otro.

La piel fetal deficiente en IL-10 cicatriza. La misma piel, con IL-10 normal, regenera.

IL-10 es antiinflamatoria: pertenece al brazo de resolución. Así que la piel fetal regenera porque tiene el tercer tiempo operando.

## Qué requiere la regeneración

La regeneración requiere que el programa se complete.

La cicatriz es lo que ocurre cuando el programa no resuelve.

`[Formulación para la consulta. La versión de la izquierda es la que hay que evitar.]`

La formulación incorrecta: *"si quitamos la inflamación, el tejido regenera."*

La correcta: *"la inflamación no impide la regeneración. La inflamación que no termina es la que la impide — y la marca que deja se llama cicatriz."*
...
Lo que está demostrado. Mujeres cuidadoras de familiares con demencia, y controles pareados. A todas la misma biopsia por punción de tres milímetros y medio.

Cicatrización: 48.7 días en cuidadoras frente a 39.3 días en controles. Y el correlato mecanístico: sus leucocitos produjeron significativamente menos ARNm de IL-1β ante estímulo.
...
La formulación defendible es esta: lo que modula la reparación es el estado defensivo de la persona. El significado que le atribuye al procedimiento puede importar, pero importaría a través de ese estado.
...
## Programa de defensa y tono de defensa

`[Al pizarrón, las dos líneas separadas.]`

**Programa de defensa** es el proceso: arranca, ejecuta, resuelve.
...
Un deslinde explícito: *mecanismos de defensa* no se usa aquí. Esa expresión pertenece a otra tradición y significa otra cosa. Aquí decimos tono.

## Una sola variable, tres escalas

Esto es lo que hace del término algo más que una etiqueta: unifica tres cosas que hasta hoy estaban sueltas en el curso.

`[Al pizarrón, tres renglones.]`

**Escala muscular.** Tensión de defensa, guardia, contractura. Es lo que ustedes reducen con la tracción y la manta antes de medir.

**Escala autonómica.** Alerta sostenida, simpático que no baja. Es el eje del estrés, que trabajamos más tarde.

**Escala inflamatoria.** Umbral bajo de activación, resolución que no llega. Es el programa de la primera parte.
...
Y lo que nos sirve es cómo describe esa ganancia: como una cantidad dinámica. Puede dispararse con la activación, volver hacia la línea base, y recalibrarse lentamente en plazos largos.

Eso es un tono, dicho en el lenguaje de la neurociencia computacional: un nivel que sube, baja, y se reajusta despacio.

Y ese mismo trabajo identifica tres vías de recalibración, que valen como mapa de por qué funcionan cosas muy distintas.

`[Al pizarrón.]`

Amplificar la retroalimentación sensorial: devolverle peso a lo que el cuerpo está informando ahora.

Reducir la activación: bajar el disparo de la ganancia.

Subir el umbral de los picos de ganancia: que se dispare menos fácil.
...
En un experimento clásico se emparejó sacarina con un inmunosupresor. Después, la sacarina sola —agua azucarada— produjo inmunosupresión medible.
...
Eso es cognición basal en sentido literal. Y justifica la frase que abre la última parte: si el tono aprende, entonces se le puede enseñar — y también se le puede enseñar mal.

---

# PARTE 4 · PLACEBO Y NOCEBO

## Por qué canal entra el efecto

La palabra *placebo* arrastra la idea de falso: lo que sobra al descontar lo real. Desde el marco del agente, ese eje está mal puesto.

La pregunta útil es por qué canal entró.
...
La naloxona, antagonista opioide, revierte la analgesia por placebo. Cuando alguien mejora con una pastilla inerte, lo que baja el dolor es su propio sistema opioide endógeno.

Nadie administró el opioide. Lo fabricó el paciente, a partir de una instrucción.

**Dos. La expectativa negativa anuló un opioide potente.**

Se administró remifentanilo a la misma dosis en tres condiciones.

`[Al pizarrón, tres renglones.]`

Sin expectativa: analgesia esperable.

Con expectativa positiva: el beneficio se duplicó.

Con expectativa negativa: el beneficio quedó abolido.

Con cambios correspondientes en la actividad de las regiones que codifican intensidad de dolor.

Una expectativa anuló un opioide que estaba entrando en vena. Si alguien duda de que la información compita con la farmacología, este es el dato.

**Tres. Funciona aunque el paciente sepa que es placebo.**

En un ensayo con pacientes con intestino irritable se entregaron pastillas presentadas explícitamente como inertes, frente a un control sin tratamiento con la misma calidad de interacción. El grupo con placebo abierto mejoró.
...
## El placebo sin cerebro

Y aquí una pieza que cierra el círculo con el Módulo 1, porque viene del mismo autor del marco.

Levin y su equipo publicaron un modelo computacional en el que el efecto placebo ocurre en redes reguladoras de genes, sin cerebro y sin sistema nervioso. El método fue tratarlas como al perro de Pávlov: un gen como estímulo condicionado, otro como incondicionado, un tercero como respuesta. En cuarenta a cincuenta redes biológicas encontraron seis tipos distintos de aprendizaje, incluido el asociativo.

El placebo, dicho como condicionamiento molecular, tiene cuatro pasos.

Un fármaco potente que produce efecto sobre la red.

Un segundo fármaco neutro, que no produce nada.

Se presentan juntos, repetidamente. La red se entrena.

Después, el neutro solo basta para activar la respuesta.
...
Y esto es exactamente la escalera de niveles de esta mañana, vista desde otra técnica y desde la clínica. Si la meta la carga un nivel superior, trabajar solo abajo mueve la manifestación sin mover el ajuste.
...
Responde: dolor, náusea, función inmune, compuerta motora en Parkinson, síntomas digestivos.

No responde: el tamaño de un tumor, la consolidación de una fractura.

Un sistema de clase A no se persuade. Ese techo es la firma de su mecanismo.

## El nocebo: subir el tono con palabras

Aquí aterriza todo el bloque.
...
Frases que suben el tono, y son frecuentes:

*"Esto te va a doler."*

*"Tienes la columna muy desgastada."* *"Tienes el cuerpo muy dañado."*

Imágenes de deterioro irreversible. Diagnósticos entregados sin marco.

Y una nuestra, que conviene revisar: *"vamos a ver todo lo que tienes mal"* al levantar el mapa.
...
`[Ejemplo al pizarrón, las dos versiones.]`

En lugar de *"tienes una degeneración importante"*:

*"Hay cambios que corresponden a tu edad y a tu historia. Lo que vamos a trabajar es cómo está regulado hoy."*
...
# PARTE 5 · CIERRE Y PUENTE

`[Recapitular en cinco líneas. Al pizarrón si hay tiempo.]`

La inflamación es un programa de defensa con meta, herencia antiquísima y tres tiempos. La resolución es un programa activo: la inflamación no se apaga, se le apaga.
...
| Soporte | Contenido |
|---|---|
| Pizarrón | Los tres tiempos del programa · las tres escalas del tono · las tres condiciones del remifentanilo · las dos columnas del techo del placebo |
| Impreso | Contraste cicatriz / regeneración para la Parte 2 |
