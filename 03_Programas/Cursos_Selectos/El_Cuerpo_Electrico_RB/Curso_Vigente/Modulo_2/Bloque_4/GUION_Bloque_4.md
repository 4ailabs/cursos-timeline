...
Este es el eje que está debajo de todos los demás.

Después de comer establecimos que lo que enferma es que el programa de defensa no se complete. Y hace un rato vimos que la analgesia del eje transversal está mientras los imanes están puestos, y empieza a persistir si se sostiene.

Ahora esas dos cosas se juntan, y sale el mecanismo candidato.

Y voy a empezar retirando una formulación que hemos usado y que está mal puesta.

`[Al pizarrón.]`

*Bajar la simpaticotonía.*

Esa frase nombra una variable y dice: hazla más pequeña. Eso es una intervención de clase A — la del reloj: se abre el sistema y se detiene la pieza que suena.

Es la lógica del diazepam. Y también la del alcohol. Los dos bajan la activación, y ninguno de los dos regula nada.

Al final de esta hora van a tener con qué sustituirla.
...
`[Al pizarrón, las seis. Marcar el perfil autonómico de cada una.]`

Uno, **arousal**: activación y orientación. Simpático.

Dos, **freeze**: la huida o la lucha puestas en espera. Simpático.

Tres, **flight o fight**: defensa activa. Simpático.

Cuatro, **fright**: inmovilidad tónica, recurso último ante amenaza inescapable. Y aquí cambia el perfil: parasimpático dominante.

Cinco, **flag o faint**: colapso, apagado conductual, disociación. Parasimpático dominante.

Y seis, **quiescent immobility**: quietud que promueve el descanso y la reparación.

Tres cosas de esta tabla.

**La primera.** Las fases tempranas son movilización simpática; las tardías son dominancia parasimpática con apagado y disociación. El parasimpático no equivale a calma: la inmovilidad tónica y el desmayo también son parasimpáticos. Lo digo porque el discurso terapéutico habitual los equipara, y ustedes van a oír esa equivalencia en muchos lados.

**La segunda, que es la decisiva.** La última fase del programa es la reparación. La cascada termina en un estado de quietud que promueve el descanso y la curación.
...
Vas conduciendo. Un coche se cruza. Frenas de golpe y no pasa nada. No hubo choque, no hubo daño, no hubo contacto.

Y entonces, cuando el peligro ya pasó, te tiemblan las manos, te falta el aire, sientes las piernas flojas, el corazón golpeando. Puede durar varios minutos.

`[Preguntar. Que levanten la mano.]`
...
Nadie confunde eso con una emoción. A nadie le parece que le tiemblan las manos porque esté triste. Es fisiología evidente.
...
Mismo frenazo. Pero llevas a alguien en el coche, o vas tarde, o estás trabajando. No te detienes. Dices *"no pasó nada"*, respiras hondo una vez y sigues conduciendo.

El temblor no ocurre. La secuencia se interrumpe.

Esa es la especificidad humana. El humano tiene el programa igual que la gacela. Lo que hace, y el animal no, es interrumpir su terminación — por contexto social, por urgencia, por vergüenza, por cortesía, por seguir funcionando.

Y el fenómeno es universal en el reino animal: los mamíferos se sacuden tras un conflicto o un susto; hay temblor postural de recuperación tras el estrés en muchas especies; y la pandiculación —el estiramiento con bostezo— es una conducta de terminación presente en prácticamente todos los vertebrados.

El programa está en todas partes. Lo que varía es si se le deja llegar al final.
...
En lenguaje etológico: un ciclo defensivo que no llegó a su última fase.

En lenguaje predictivo: una predicción que no recibió evidencia en contra.

Y en el nuestro, el bioeléctrico: una isla que no se re-enroló en el colectivo.

Son la misma cosa vista desde tres sistemas.
...
# PARTE 3 · QUÉ DICE LA ALOSTASIS

Aquí hay una sorpresa útil: la alostasis, bien leída, dice justamente lo que el curso necesita.
...
Y ahora su definición de salud, que es la que nos sirve:
...
`[Referencia: Sterling. Physiology and Behavior 2012. PMID 21684297.]`
...
Y es lo mismo que este curso ya dice en otros tres lugares.

`[Al pizarrón, cuatro renglones.]`

El general japonés predice: *la guerra sigue*.

El ojo miope predice: *el mundo será cercano*.
...
*Bajar la simpaticotonía*: suprime un valor. Clase A. **Se retira.**

*Restaurar la alternancia activación y recuperación*: devuelve la capacidad de subir y bajar. Clase B. Correcta, y dice qué sin decir cómo.

**Entregar la señal de que el episodio terminó, para que el sistema actualice su predicción**: actualiza el modelo que sostiene el estado. Clase B. **Es la que explica el mecanismo, y es la que usamos.**

---

# PARTE 5 · QUÉ SE MIDE

Si el objetivo no es bajar un valor, entonces el marcador tampoco puede ser un valor.

`[Al pizarrón, dos columnas.]`

No se mide cuánto bajó el simpático: se mide **la amplitud**. ¿Puede subir cuando toca?

No se mide el nivel en reposo: se mide **el tiempo de retorno**. ¿Puede bajar, y en cuánto?

No se mide un número aislado: se mide **la variabilidad**. ¿Modula?

Y no se mide el alivio del día: se mide **cuánto dura**.

Y hay una coherencia interna que conviene ver. El marcador que ya usamos —la variabilidad de la frecuencia cardíaca— mide flexibilidad.

Una HRV alta significa capacidad de modular. El marcador que ya habíamos elegido implicaba el marco correcto; la formulación era la que iba atrasada.

Para la ficha, los marcadores del eje: HRV, ritmo diurno de cortisol, presión y frecuencia en reposo.

---

# PARTE 6 · QUÉ HACE EL RASTREO DEL EJE TRANSVERSAL

Ahora podemos decir qué hace la técnica que practicaron hace un rato.
...
Y eso explica el fenómeno que vimos, sin añadir nada.
...
Y si se sostiene hasta que ya no marca, algo persiste: la evidencia se acumuló lo suficiente para actualizar el modelo.
...
`[Las dos versiones, al pizarrón.]`

La que se retira: *"estos puntos bajan el simpático y te relajan."*

La correcta: *"estos puntos le entregan al sistema una información que no coincide con la amenaza que está prediciendo. Si la sostienes lo suficiente, el sistema actualiza la predicción — y entonces baja solo."*
...
## Las personas se duermen profundamente

Es la última fase del programa.
...
Y refuerza la corrección que hicimos hace un rato. Las citas invertidas mostraban que la estimulación vagal consolida NREM profundo y reduce REM. Que las personas se duerman profundamente es coherente con la versión corregida.

## Temblores espontáneos

Y aquí un detalle metodológico que importa mucho, y que está a favor del método: son espontáneos.

Las técnicas de temblor terapéutico lo inducen deliberadamente, con posturas o con fatiga muscular provocada. Aquí aparece solo.

Eso lo saca de la categoría de maniobra provocada y lo coloca en la de fenómeno observado, que es una posición mucho más fuerte.
...
`[Las tres formulaciones, al pizarrón.]`
...
# PARTE 8 · POR QUÉ ESTO NO ES UNA TÉCNICA EMOCIONAL
...
**Dos. Cambiaría lo que hace el operador.** Si se llama emocional, el operador empieza a perseguir la descarga: provoca, insiste, interpreta, busca la lágrima como prueba de que funcionó. Y entonces deja de rastrear y pasa a dirigir.
...
`[Demostración con la red desplegada zona por zona. Luego dos rondas de 24 minutos.]`

Cada uno va a rastrear y aplicar la red bilateral, y a observar qué produce.

La secuencia.

Se rastrea todo y se aplica solo donde marca. La regla no cambia.

Negativo en el punto que marca; positivo en su homólogo contralateral.

Se recorre por zonas.

Y se registra: qué zonas marcaron, cuáles no, y qué se observó.
...
Esa última comprobación —retirar y volver a medir— es un experimento cruzado dentro del mismo sujeto. Es lo que convierte la práctica en registro.

---

# PARTE 10 · CIERRE DEL MÓDULO

## Lo que queda establecido

Hoy ejecutaron la sesión completa del nodo de lesión, de principio a fin.
...
Quedan dos ejes que hoy no abrimos: el intestinal y el metabólico. Son los terrenos que sostienen todo lo demás desde dentro.

Y queda la tercera modalidad de rastreo, el rastreo por sensación, con su encuadre propio.
...
| Soporte | Contenido |
|---|---|
| Pizarrón | Las seis fases de la cascada · las cuatro predicciones congeladas · la tabla de las tres formulaciones · qué se mide frente a qué no |
| Por alumno | Juego de imanes y hoja de registro de la práctica |
