...
Buenos días. Bienvenidos al segundo módulo.

En el primero trabajamos el marco: qué es el cuerpo eléctrico, con qué instrumento se trabaja, cómo se interpreta y cuál es el procedimiento. Describimos ese procedimiento de principio a fin.
...
`[Preguntas al grupo. Confirmar o corregir en una frase.]`

¿Qué señal indica nodo activo, y cuál indica resolución?
`[Acortamiento / isometría.]`

¿Cuál es la pierna de referencia?
`[La izquierda.]`

¿Qué actúa sobre la zona, la intensidad o el gradiente?
`[El gradiente, en la frontera entre polos opuestos.]`

¿Qué organiza, el Vmem o el pH?
`[El Vmem. El pH acompaña.]`

¿Qué es un agente biológico?
`[Persigue una meta y defiende un set point.]`

En el eje de persuadibilidad, ¿de qué clase son los agentes del cuerpo?
`[Clase B. Se les reescribe la referencia.]`

¿Qué es una isla de despolarización?
`[Zona despolarizada que cerró sus uniones comunicantes y quedó desconectada del colectivo.]`

¿Qué significa que regular no es curar?
`[Recalibrar el punto de ajuste en lugar de suprimir el síntoma.]`

`[Al pizarrón. Escribir la columna con huecos y que el grupo la complete.]`

Dejemos esto escrito, porque lo vamos a usar todo el día.
...
Ese último paso es el de hoy.

`[Repartir: manual, hoja de valoración previa, siluetas.]`

Les entrego tres cosas. El manual operativo del nodo de lesión, con el que van a trabajar de aquí en adelante. Una hoja de valoración previa, que vemos en la segunda parte. Y siluetas de mapa corporal para la práctica.

---

# 10:20 · LA SESIÓN DEL NODO DE LESIÓN

`[Con el manual abierto. Ir pasando páginas con el grupo.]`

## Los materiales

Abran el manual en "antes de empezar".

Los imanes pueden ser cuadrados, rectangulares o circulares. El tamaño se elige por la zona a tratar y por la complexión del paciente. La misma zona pide un calibre distinto en un paciente delgado que en uno de complexión robusta.

La intensidad en superficie va de 0.1 a 0.5 tesla: de 100 a 500 militesla.

Van cubiertos y con lengüeta para separarlos. A esas fuerzas, dos imanes que se juntan de golpe pueden pinzar tejido o fracturarse.

Para la rejilla, cuatro imanes iguales entre sí.

Antes de aplicar cada imán, identifiquen la cara: Norte es el polo negativo, Sur el positivo.

La camilla, sin superficie metálica, y a la altura de su cintura. Van a medir muchas veces en una sesión y esa altura determina si la sostienen.

Y el cribado de seguridad, cuatro casillas: marcapasos, embarazo, prótesis y quimioterapia. Cualquiera marcada obliga a valorar antes de aplicar, y se registra en la ficha.

## La convención de polos

`[Marcar en el pizarrón.]`

El polo negativo, Norte, es el de rastreo e impactación sobre la zona. El positivo, Sur, es el complementario. En la aplicación general, la cara negativa contacta la piel.
...
Pasen a la ficha clínica. Formato SOAP.

En subjetivo: datos, motivo de consulta, síntomas en el lenguaje del paciente, tratamientos actuales y previos, medicación, y el cribado. En objetivo: el mapa corporal, anterior y posterior. En valoración: los nodos hallados. En plan: técnicas y seguimiento.

Retengan esa última palabra, seguimiento. Volvemos a ella al cerrar esta parte.
...
A cada hallazgo, intensidad en escala de 0 a 10. Eso es lo que hace comparable esta sesión con la siguiente.
...
Se le explica al paciente qué se le va a realizar: evaluación de simetría y colocación de imanes, indolora y no invasiva. Se le pide retirar joyas, reloj, cinturón, llaves y dispositivos electrónicos.
...
Izquierda de referencia, derecha como variable.

De ahí sale la primera bifurcación. Talones isométricos: se pasa directo al rastreo por zonas. Acortamiento funcional: primero se establece la línea base.

## El diagrama de la sesión

`[Dibujar el árbol completo en el pizarrón mientras se explica.]`

Todo lo que van a hacer hoy está en este diagrama. Cada rama la decide una medición.
...
Ustedes proponen la zona; el rastreo confirma el punto.
...
Y es un dipolo de gradiente: los dos polos opuestos y adyacentes generan un gradiente de campo empinado en el tejido intermedio. Es ese gradiente, y no la intensidad del imán, el que actúa.

## Cuando el dipolo local no cierra

Si el positivo adyacente no restablece la isometría en ninguna posición, la zona requiere un nodo regulador a distancia.

El negativo permanece sobre la zona. Se retira el positivo que se probó al lado. Y se busca en orden fijo, midiendo en cada paso.

`[Señalar en el propio cuerpo mientras se enumera.]`

Zona renal derecha: región lumbar posterior, bajo las últimas costillas, lateral a la columna. Después la izquierda.

Suprarrenal derecha: sobre el polo superior de la zona renal. Después la izquierda.

Hígado: hipocondrio derecho, rastreando sobre la piel toda la zona hepática.

Bulbo raquídeo: nuca, en el hueco por debajo del occipucio.

Si ninguno restablece la isometría, se rastrea el resto del cuerpo.

El orden está construido por prevalencia. El riñón es el nodo regulador principal y el único establecido, porque regula el potasio, la variable que domina en la despolarización aguda. Suprarrenal, hígado y bulbo son nodos propuestos, en investigación: efector neuroendocrino, efector metabólico y control autonómico central respectivamente.
...
Por eso la ficha tiene casilla de seguimiento, y por eso el mapa con la escala se levanta en cada sesión.

Una formulación para la consulta:
...
`[Preguntar al grupo. Escuchar dos o tres respuestas.]`

¿A quién le ha pasado? ¿Qué hicieron?

La lectura correcta: que no marque no indica ausencia de daño. Indica que el mecanismo está operando en otro nivel.
...
Son tres mecanismos distintos, no tres grados de gravedad. Y el mecanismo determina a qué nivel se dirige la pregunta.
...
Es el tercer descriptor de la clasificación, y es el que faltaba. Antes de tener nombre, ese paciente recibía "no tiene nada" o una lista de diagnósticos que no explicaban el cuadro. Fibromialgia, síndrome de dolor regional complejo, migraña crónica y buena parte del dolor lumbar crónico corresponden aquí.
...
En predominantemente nociplástico, puede no marcar donde duele.

Con eso, el punto que duele y no marca queda explicado: es lo esperable cuando predomina el componente nociplástico. El rastreo está respondiendo con precisión a una pregunta dirigida al nivel equivocado.
...
Y dos moduladores transversales a toda la cascada.
...
Y los **factores psicosociales biológicamente arraigados**: estrés, trauma y adversidad modifican el eje hipotálamo-hipófisis-suprarrenal, las monoaminas y los umbrales. Operan como mecanismo, no como acompañamiento.

## Inflamación periférica e inflamación central

La inflamación involucra dos sistemas inmunes, y hasta ahora habíamos trabajado uno.

El **compartimento periférico**: células inmunes en el sitio de lesión, con colapso del gradiente de potasio, inflamasoma y corriente de lesión. Es la isla del trauma.

El **compartimento central**: microglía y astrocitos, el sistema inmune del sistema nervioso central. Ante señalización nociceptiva persistente se activan y liberan TNF-alfa, interleucina 1-beta, interleucina 6 y BDNF, que incrementan la excitabilidad neuronal y remodelan la sinapsis.
...
Y el dato central: la microglía poda las sinapsis inhibitorias. Es una remoción estructural del control inhibitorio. El sistema central no solo deja de recibir la señal de alto; pierde el sustrato que la ejecutaría.
...
Cinco reglas para formularlas.

Una variable por pregunta. Si se modifican dos condiciones a la vez, la respuesta no discrimina cuál la produjo.

Predecir antes de comprobar. Enunciar en voz alta qué se espera, y después medir. Es lo que construye criterio.

Repreguntar de otra forma cuando la respuesta sea dudosa. El canal tiene ruido, y la redundancia lo compensa.

Cambiar de nivel cuando el nivel se agota, en lugar de insistir. Insistir es el error más frecuente.

Y registrar la trayectoria, no solo el desenlace: qué niveló, en qué orden, y cuándo dejó de nivelar.

`[Cierre.]`

Vamos a un receso de veinte minutos. Al volver, levantan un perfil bioeléctrico completo, dos rondas, para que cada uno opere una vez.
