# El Cuerpo Eléctrico
## Manual de trabajo · Módulo 2 — Leer y regular
...
# Módulo 2 · Bloque 1 — La sesión del nodo de lesión
### Tipos y niveles de dolor

> El Módulo 1 describió el procedimiento. Este bloque lo ejecuta de principio a fin: los materiales, la ficha, el mapa, la medición, el algoritmo de decisión, los dipolos y el cierre. Y añade lo que el Módulo 1 no cubrió: qué hacer cuando una zona duele y el rastreo no marca.

---

## 1. Conceptos operativos del Módulo 1
...
## 3. La convención de polos

**El polo negativo, Norte**, es el de rastreo e impactación sobre la zona.
**El polo positivo, Sur**, es el complementario: cierra el dipolo, local o a distancia.
...
## 7. El algoritmo de la sesión

Cada rama la decide una medición.

```
MEDIR SIMETRÍA BASAL
├── isométrico ──────────────────────────► RASTREO POR ZONAS
│
└── acortamiento ──► ACIDOSIS TEMPORAL
                     ├── isometría ──► dipolo local renal ──► verificación por retirada
                     │                                        ├── se sostiene ──► RASTREO POR ZONAS
                     │                                        └── reaparece ───► ACIDOSIS LATENTE
                     └── sigue acortado con el imán puesto ──► DISCREPANCIA ANATÓMICA

RASTREO POR ZONAS  (por cada zona del mapa, de mayor a menor intensidad)
   negativo en la zona ──► ¿acorta?
       ├── no ──► mover el imán por la zona · si nada, siguiente zona
       └── sí ──► positivo adyacente ──► ¿isometría?
                    ├── sí ──► DIPOLO LOCAL CERRADO
                    └── no ──► NODOS DISTANTES, en orden fijo
                                 riñón D · riñón I · suprarrenal D · suprarrenal I
                                 hígado · bulbo · cuerpo entero
```
...
## 10. Los nodos distantes, en orden fijo
...
| 3 | Suprarrenal derecha | Sobre el polo superior de la zona renal | Efector neuroendocrino | En investigación |
| 4 | Suprarrenal izquierda | Homóloga contralateral | | En investigación |
| 5 | Hígado | Hipocondrio derecho, rastreando toda la zona hepática sobre la piel | Efector metabólico | En investigación |
...
2. Medir la simetría.
3. Si vuelve a acortar, recolocar y prolongar.
4. Se repite hasta que, al retirarlo, queden isométricas.

---

## 13. Cierre de sesión y serie terapéutica
...
*Kosek E, et al. Chronic nociplastic pain affecting the musculoskeletal system: clinical criteria and grading system. Pain 2021;162(11):2629-2634. PMID 33974577 · Finnerup NB, et al. Neuropathic pain: an updated grading system. Pain 2016;157(8):1599-1606. PMID 27115670*

---

## 15. Los cuatro niveles del dolor
...
## 16. Inflamación periférica e inflamación central

La inflamación involucra dos sistemas inmunes, y hasta ahora trabajábamos uno.

**El compartimento periférico.** Células inmunes en el sitio de lesión, colapso del gradiente de potasio, inflamasoma y corriente de lesión. Es la isla del trauma, y ahí el rastreo marca.

**El compartimento central.** Microglía y astrocitos, el sistema inmune del sistema nervioso central. Ante señalización nociceptiva persistente se activan y liberan **TNF-α, IL-1β, IL-6 y BDNF**, que incrementan la excitabilidad neuronal y remodelan la sinapsis.
...
> **La microglía poda las sinapsis inhibitorias.** Es una remoción estructural del control inhibitorio: el sistema central pierde el sustrato que ejecutaría la señal de alto.

---

## 17. La hoja de valoración previa
...
| Déficit neurológico progresivo | *Progresivo* es la palabra clave. Un déficit estable puede seguirse; uno que avanza obliga a estudiar por qué avanza, y a hacerlo pronto |
...
## 18. Naturaleza de la respuesta al rastreo
...
1. **Una variable por pregunta.** Si se modifican dos condiciones a la vez, la respuesta no discrimina cuál la produjo.
2. **Predecir antes de comprobar.** Enunciar qué se espera, y después medir. Es lo que construye criterio.
3. **Repreguntar de otra forma** cuando la respuesta sea dudosa. La medición tiene variabilidad, y repetir de otro modo la reduce.
4. **Cambiar de nivel cuando el nivel se agota**, en lugar de insistir. Insistir es el error más frecuente.
5. **Registrar la trayectoria, no solo el desenlace:** qué niveló, en qué orden, y cuándo dejó de nivelar.

---

## 19. Síntesis del bloque
...
# Módulo 2 · Bloque 2 — El programa de defensa
### Inflamación, cicatriz y respuesta a la información

> El Bloque 1 estableció que lo desregulado es el punto de ajuste, y que el rastreo señala una zona fuera de rango. Este bloque toma esa idea y la lleva a un agente concreto: el sistema de defensa. Su objeto es la inflamación leída como programa, y la variable que se regula.

---

## 1. La inflamación como programa
...
## 2. Conservación evolutiva del programa
...
## 6. Modulación de la reparación por el estado defensivo
...
Y el correlato mecanístico: los leucocitos de las cuidadoras produjeron significativamente menos ARNm de IL-1β ante estímulo.
...
*Kaptchuk TJ, et al. Placebos without deception: a randomized controlled trial in irritable bowel syndrome. PLoS One 2010;5(12):e15591. PMID 21203519*
...
1. Un fármaco potente que produce efecto sobre la red.
2. Un segundo fármaco neutro, que no produce nada.
...
# Módulo 2 · Bloque 3 — La escala sistémica
### El punto gatillo, el eje transversal y la bilateralidad

> Todo lo trabajado hasta aquí tenía historia: un golpe, una lesión, un nodo. Este bloque introduce un objeto distinto — algo que duele, que se comporta como nodo, y que no tuvo trauma. Y con él, la segunda mitad del método: la red bilateral de cuerpo entero.
...
Junto con ella aparecieron **bradicinina, sustancia P y CGRP**, que son el perfil de la inflamación neurógena: mediadores liberados por la propia terminación nerviosa, no por células inmunes migradas. Aparecieron también las **citoquinas TNF-α, IL-1β, IL-6 e IL-8**, y **serotonina y noradrenalina** — estas dos últimas relevantes porque son las que la modulación descendente utiliza.
...
## 2. El rastreo de nodos para el eje transversal
...
> **"Vagal" afirma un mecanismo que no está demostrado, y pelea con la anatomía**: el vago no es simétrico. El derecho influye el nódulo sinusal y la frecuencia; el izquierdo, el auriculoventricular y la conducción. Difieren hasta en número de fibras.
>
...
## 3. La hipótesis de la bilateralidad
...
## 4. Las tres geometrías de dipolo
...
> **Estos puntos se tienen que rastrear. No se ponen todos.**
>
> **Se coloca el imán negativo en la zona. Y si sale, el polo positivo va, generalmente, en el punto homólogo del lado contrario.**
...
# Módulo 2 · Bloque 4 — El eje del estrés
### El ciclo defensivo, la alostasis y la predicción que no se actualizó

> Este es el eje que está debajo de todos los demás. El Bloque 2 estableció que lo que enferma es que el programa de defensa no se complete. El Bloque 3 mostró que la analgesia del eje transversal es reversible mientras se aplica y persiste si se sostiene. Aquí las dos cosas se juntan.

---

## 1. Revisión de la formulación "bajar la simpaticotonía"
...
## 2. Las seis fases del ciclo defensivo
...
> Una gacela es perseguida por un depredador y escapa. La amenaza ha terminado y el animal está ileso.
>
> Entonces, ya a salvo, **el animal tiembla**. Sacude el cuerpo durante un tiempo variable, y después reanuda el pastoreo con un perfil autonómico normal.
...
> Un conductor circula con normalidad. Otro vehículo se le cruza. Frena de golpe y no ocurre nada: no hubo impacto, no hubo daño, no hubo contacto.
>
> Y entonces, **cuando la amenaza ya pasó**, aparecen temblor en las manos, disnea, debilidad en las piernas y palpitaciones. El cuadro puede durar varios minutos.
...
> Mismo episodio. Pero el conductor lleva pasajeros, o va con retraso, o va trabajando. **No se detiene.** Concluye que no ha pasado nada, respira hondo una vez y continúa.
>
> El temblor no aparece. La secuencia queda interrumpida.

**Ahí está la diferencia entre las dos especies.** El humano tiene el programa igual que la gacela; lo que hace, y el animal no, es interrumpir su terminación — por contexto social, por urgencia, por vergüenza, por cortesía, o simplemente por seguir funcionando.
...
## 4. El ciclo defensivo incompleto
...
## 6. La simpaticotonía sostenida como predicción
...
> **Un ciclo defensivo completado es esa evidencia.**
>
...
## 8. Lectura del rastreo del eje transversal
...
## 9. Observaciones clínicas durante la aplicación
...
La persona no llora porque se le hayan liberado emociones. Llora porque bajó la guardia, y la guardia era lo que impedía la expresión.
...
> **La expresión emocional viene después.** Se modificó el estado; lo demás vino detrás.
...
>
> **No se busca. No se provoca. No se interpreta. No se persigue.**
> **Si aparece, se acompaña. Si no aparece, la sesión está igual de completa.**
...
> **BV4 trabaja improntas, y lo hace con un protocolo propio** — la frase integrativa, la ventana de reconsolidación, el Acto de Quiebre. Es un trabajo deliberado, con su formación y su encuadre.
>
> **La Regulación Bioeléctrica trabaja el estado, y lo hace con el rastreo.** Si en el camino aparece una descarga, se acompaña y se cierra.
>
...
## 11. Protocolo de práctica supervisada

**Objetivo:** rastrear y aplicar la red bilateral, y observar qué produce.

### Secuencia de aplicación

1. **Se rastrea todo, se aplica solo donde marca.** La regla no cambia.
2. **Negativo en el punto que marca; positivo en su homólogo contralateral.**
3. Se recorre **por zonas**.
4. Se registra: qué zonas marcaron, cuáles no, y qué se observó.
