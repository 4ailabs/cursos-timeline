#!/usr/bin/env python3
"""
Genera el manual B5 imprimible del Módulo 2 a partir del markdown.

Sistema de diseño: el mismo de `manual_nodo_lesion.html` (B5 176×250 mm,
Avenir Next, teal #0F6E56, columna única, coral solo para alertas).
Reglas de marca: Manual_Nodo_Lesion_GUIA_CONSTRUCCION.md

Uso:  python3 build_manual_b5.py
Sale: Manual_Modulo_2_B5.html
"""
import re, html, pathlib, sys

SRC = pathlib.Path("Manual_Modulo_2_Leer_y_Regular.md")
...
BLOQUES = [
    ("Tipos y niveles de dolor",                        "Bloque 1 · La sesión del nodo de lesión"),
    ("Inflamación, cicatriz y respuesta a la información", "Bloque 2 · El programa de defensa"),
    ("El punto gatillo, el eje transversal y la bilateralidad", "Bloque 3 · La escala sistémica"),
    ("El ciclo defensivo, la alostasis y la predicción que no se actualizó", "Bloque 4 · El eje del estrés"),
]
...
<div class="brand">{DIPOLO}<span class="wordmark">regulación <b>bioeléctrica</b></span><span class="sp"></span><span class="rh">Módulo 2 · Leer y regular</span></div>
{cab}
...
<div class="gap-t"></div>
<div><p class="kicker">Manual de trabajo · Módulo 2</p><h1>Leer y regular</h1>
<p class="sub">La sesión del nodo de lesión, el programa de defensa, la escala sistémica y el eje del estrés.</p></div>
<div class="gap-b"></div>
...
<p class="sub">Manual de trabajo del Módulo 2 del programa El Cuerpo Eléctrico, formación en Regulación Bioeléctrica.</p>
