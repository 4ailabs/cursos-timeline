# Bloque 3 · Guion de clase
## La escala sistémica: del lugar al estado
...
`[Cuatro preguntas al grupo. Confirmar o corregir en una frase.]`

Antes de entrar, recuperemos lo de hoy.
...
Y tres frases ordenan el bloque.

`[Al pizarrón.]`

El punto gatillo está siendo mantenido activo.

Una analgesia que se apaga al retirar el estímulo es una compuerta.

Aplicar en simetría anula el lugar. Lo que queda es el nivel.

---

# PARTE 1 · EL PUNTO GATILLO

## Qué es un punto gatillo si no hubo trauma

`[Lanzar la pregunta y dejar pensar.]`

Si un punto gatillo duele y responde, pero nunca hubo trauma ahí, ¿qué es?

`[Escuchar dos o tres respuestas antes de dar la formulación.]`

## Los cuatro mecanismos protectores que fallan

La formulación más reciente lo reencuadra en términos de control.

Los mecanismos mioprotectores que responden a la sobreactividad, al ATP bajo o al pH bajo fallan en proteger. Y el resultado es acumulación de calcio, puentes actina-miosina persistentes —la contracción que no suelta— y activación nociceptiva.

Cuáles son esos mecanismos.

`[Al pizarrón, los cuatro.]`

La modulación simpática pre y postsináptica. Retengan esta: el autónomo forma parte del control.

Los moduladores de la acetilcolina en la unión neuromuscular.

El canal de potasio dependiente de ATP.

Y el receptor de rianodina, el canal que libera el calcio.
...
Con microdiálisis in vivo, comparando puntos activos, puntos latentes y músculo normal.

En los activos: pH de 4.7 a 5.0. Bradicinina, sustancia P y CGRP — inflamación neurógena. TNF-α, IL-1β, IL-6 e IL-8. Serotonina y noradrenalina.

Y elevados también en sitios remotos.
...
El sistema alfa-adrenérgico potencia la acetilcolina en la unión neuromuscular del punto.
...
## Cómo distinguir punto gatillo de nodo de lesión
...
# PARTE 2 · EL RASTREO DE NODOS PARA EL EJE TRANSVERSAL

## Por qué se deja de llamar "puntos vagales"

Hasta hoy esta técnica se ha llamado Técnica 5, inducción de tono vagal, o red parasimpática. La cambiamos de nombre, y explico el motivo.

"Vagal" afirma un mecanismo que no está demostrado. Y además pelea con la anatomía, porque el vago no es simétrico: el derecho influye el nódulo sinusal y la frecuencia; el izquierdo, el auriculoventricular y la conducción. Difieren hasta en número de fibras.

Una red simétrica no puede llamarse vagal sin contradecir la asimetría del vago.

`[Al pizarrón, los términos.]`

**Nodo del eje transversal**: cada par bilateral.

**Rastreo de nodos para el eje transversal**: el conjunto de los diez.

**Dipolo cervical–sacro**: conserva su nombre, porque es el ancla axial.

Y queda formado el par que faltaba: nodo de lesión frente a nodo del eje transversal. Un lugar frente a un estado.

`[Si se quiere conservar la referencia fisiológica al enseñar: "los nodos del eje transversal, que recorren el eje craneosacro" — describe el trayecto sin afirmar el mecanismo.]`

## Los diez puntos y su orden

Se presentan descendiendo por el eje, como en la figura del manual del Módulo 1.

`[Enumerar señalando en el propio cuerpo.]`

Pineal. Base del cráneo. Supraclavicular. Escápula. Tricipital. Riñón. Suprarrotuliano. Aquiles superior. Empeine. Y cervical–sacro.

Dos precisiones de ejecución.

Se rastrean y se aplican como dipolos bilaterales: cada punto es un par derecha e izquierda.

Y el décimo no es uno más. Ancla la red en los dos extremos del eje.
...
## Por qué la analgesia es de estado y no de tejido
...
Ahora comparen B y C con D.

`[Al pizarrón, dos renglones.]`

B y C mueven la ganancia: la compuerta está abierta mientras hay estímulo, y se apaga al retirar.

D mueve el punto de ajuste, y persiste.

Y aquí el criterio de tiempo del método deja de ser costumbre. Dejar hasta que ya no marque es la diferencia entre alquilar el efecto y empezar a quedárselo.

Por eso la pregunta de seguimiento correcta es *¿cuánto te duró?* Sin esa pregunta no se sabe cuánto de D se consiguió.

## El movimiento ocular como marcador de estado

La observación es real. Lo que no se sostiene es la atribución al sueño REM.

Y lo digo completo, porque el error fue nuestro: las dos citas que respaldaban esa atribución se usaron con el sentido invertido. La estimulación vagal consolida NREM profundo y reduce REM. Y el generador primario del REM es pontino, no bulbar.
...
# PARTE 3 · LA HIPÓTESIS DE LA BILATERALIDAD

## Qué interroga un par bilateral

Un punto unilateral interroga un lugar. Un par bilateral interroga un estado.

La lateralidad es la variable de los sistemas que localizan. La simetría, la de los sistemas que fijan el nivel.

## El plano medio se establece en las dos primeras horas

Aquí entra Levin, y con su trabajo fundacional.

La asimetría izquierda-derecha del embrión se establece por un flujo iónico y un gradiente de voltaje asimétricos a través de la línea media, dependientes de una H⁺/K⁺-ATPasa y un canal de potasio, con uniones comunicantes transmitiendo la señal.

Y el dato que impresiona: el ARNm de esa bomba se expresa simétricamente en el embrión de una célula, y se localiza en las dos primeras divisiones. La asimetría se genera dentro de las dos horas posteriores a la fecundación.

Antes de que haya nervios, órganos o los genes que se creían el origen. Y con exactamente la maquinaria de este curso: bombas, canales, uniones comunicantes.

Tres piezas más, para quien quiera el fondo.

El mecanismo de traducción es un modelo de electroforesis de morfógenos a través de uniones comunicantes: cómo un voltaje se convierte en instrucción de posición.

La consecuencia global: invertir la asimetría izquierda-derecha altera el desempeño de renacuajos en tareas cognitivas sin componente lateral. La lateralidad corporal no es cosmética.
...
**Propagación neural.** El vehículo es la delegación de la meta a un agente mayor. La dirección es hacia arriba por el eje. Explica la cronificación y el punto que no marca.

**Propagación por cadena.** El vehículo es la continuidad de tejido y la transmisión de fuerza. La dirección es a lo largo de la cadena. Explica hallazgos distantes que no siguen dermatoma ni segmento.

Una viaja por decisión; la otra por continuidad.

## Las siete cadenas de Busquet
...
Y un dato de nomenclatura que dice mucho: el método pasó de llamarlas *cadenas musculares* a *cadenas fisiológicas*, precisamente para dar lugar a la visceral y la neurovascular. El propio autor concluyó que lo muscular no bastaba.
...
Las cadenas no persiguen ninguna meta, no defienden ningún punto de ajuste, y no deliberan.

Son el medio por el que un agente sufre las consecuencias de otro.
...
# PARTE 5 · EL DEPORTISTA

## Qué canal engancha el tape, la aguja y el imán

`[Al pizarrón, tres renglones.]`

El **tape** es una entrada cutánea sostenida, no nociva. Amplifica la retroalimentación sensorial.

La **aguja** es un estímulo nocivo más disrupción mecánica. Toca lo local y lo descendente.

El **imán** es gradiente local más red distribuida, no nociva. Mueve el punto de ajuste local, y la ganancia está por determinar.

La aguja es la única de las tres que es nociva. Y la inhibición condicionada requiere estímulo nocivo. Tiene de entrada el mecanismo descendente que nosotros todavía debemos demostrar.

La evidencia, sin adorno: el tape no supera al simulado, su efecto es clínicamente trivial, y no reduce lesiones ni mejora rendimiento. En la aguja, los cambios bioquímicos tras la respuesta de espasmo están descritos, pero provocar esa respuesta no se correlaciona con el resultado.

## Por qué silenciar el dolor tiene un costo

Si el punto gatillo es el fallo de un mecanismo protector, entonces el dolor que produce es lo que queda de esa protección.
...
Nunca desensibilizar y devolver a carga máxima el mismo día.

## Cuándo el punto es un síntoma de la temporada

El deportista en bloque reúne carga alta, deuda de sueño y estrés de competencia.

Y la privación de sueño sube la ganancia, deteriora la inhibición condicionada y facilita la sumación temporal. Las tres a la vez.

Tratarlo localmente y devolverlo al mismo régimen produce el desplazamiento que describía Mason: se limpia aquí y aparece allá. El punto siguiente es el mismo estado buscando otra salida.

La pregunta previa, siempre: *¿cuánto duerme, cuánta carga lleva, y cuánto hace que aparecen estos puntos?*
...
`[Recapitular en cinco líneas.]`

El punto gatillo es un fallo de control mantenido por tono simpático.

El rastreo de nodos para el eje transversal produce una analgesia de estado, reversible mientras se aplica, y que empieza a persistir si se sostiene hasta que el rastreo no marca.

La bilateralidad es el marcador de que se está tocando un estado y no un lugar. Y el plano medio es un cómputo bioeléctrico desde las primeras horas de vida.

Las cadenas aportan una segunda topología de propagación, y no son agentes.
...
| Soporte | Contenido |
|---|---|
| Instrumento | Algómetro de presión, para la demostración de la Parte 2 y para que lo vean funcionar |
| Pizarrón | Los cuatro mecanismos protectores · los diez puntos en su eje · las dos topologías de propagación |
| Por alumno | Juego de imanes |
